  ...
  return (
    <section className="pt-32 pb-10 px-4 max-w-7xl mx-auto flex flex-col items-center text-center">
      ...
      <div className="max-w-4xl mx-auto mb-16 mt-4">
        <h1 className="text-4xl md:text-[5rem] font-medium tracking-tight text-gray-900 mb-6 leading-[1.05]">
          Finanzen neu gedacht — <br />für eine bessere Zukunft.
        </h1>
        <p className="text-base md:text-lg text-gray-500 max-w-2xl mx-auto font-medium leading-relaxed">
          Drei spezialisierte Apps für Steuern, Versicherungen und Treuhand —
          jede entwickelt, um dir Zeit und Geld zu sparen.
        </p>
      </div>
      ...
      <div className="w-full max-w-6xl mx-auto">
        <div className="bg-surface rounded-[2.5rem] relative">
              ...
              {tabs.map((tab) => {
                ...
                return (
                  <button
                    ...
                    className={`relative px-4 sm:px-6 py-2.5 rounded-full text-sm font-semibold cursor-pointer ${
          ...
          {/* Content — fixed height so container doesn't shift between tabs */}
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-2 items-center p-6 sm:p-8 lg:p-10 xl:p-12 min-h-[580px] lg:min-h-[620px]">
            {/* Left: Info */}
            <div key={activeTab} className="text-left pl-2 lg:pl-6 min-h-[360px] flex flex-col justify-center tab-fade-in">
              ...
              {/* Heading */}
              <h2 className="text-3xl sm:text-4xl lg:text-[2.8rem] xl:text-5xl font-medium tracking-tight text-gray-900 leading-[1.1] mb-5">
                {current.heading}
              </h2>
              ...
              {current.available ? (
                ...
                <div className="flex flex-col gap-4">
                  ...
                  {/* Waitlist CTA */}
                  <div className="bg-white/80 backdrop-blur-sm border border-gray-200 rounded-2xl p-4 max-w-md">
                    <p className="text-sm font-semibold text-gray-700 mb-3">
                      Benachrichtigt werden, sobald verfügbar?
                    </p>
                    <div className="flex gap-2">
                      <input
                        type="email"
                        placeholder="deine@email.ch"
                        className="flex-1 px-4 py-2.5 rounded-xl bg-surface border border-gray-100 text-sm font-medium text-gray-900 placeholder:text-gray-400 focus:outline-none focus:border-gray-300 focus:ring-2 focus:ring-accent/20"
                      />
                      <button className="bg-accent text-accent-text px-5 py-2.5 rounded-xl text-sm font-bold hover:bg-accent-hover transition-colors shadow-sm whitespace-nowrap">
                        Anmelden
                      </button>
                    </div>
                  </div>
          ...
          <div className="mx-8 sm:mx-10 lg:mx-12 border-t border-gray-200/60">
            <a
              href="#services"
              className="group flex items-center justify-center gap-2 py-5 text-[13px] font-semibold text-gray-400 hover:text-gray-900 transition-colors duration-300 cursor-pointer"
            >
...
function PhoneSteuer({ }: { theme: string }) {
  return (
    <div className="relative w-[270px] sm:w-[285px] h-[555px] sm:h-[585px] bg-device-body rounded-[2.8rem] border-[6px] border-device-border shadow-device overflow-hidden">
      <DynamicIsland />
      <div className="w-full h-full bg-white pt-12 flex flex-col">
        ...
        <div className="px-5 pt-2.5 pb-2 flex justify-between items-center">
          <div className="flex items-center gap-2">
            <img src="/avenzo_icon.svg" className="h-[14px] w-auto object-contain" style={{ filter: "brightness(0)" }} alt="Avenzo" />
            <span className="text-[10px] font-bold tracking-[0.08em] text-gray-900">avenzo</span>
          </div>
        ...
        <div className="flex-grow flex flex-col relative overflow-hidden bg-surface-subtle">
          ...
          <div className="absolute inset-0 flex flex-col anim-fade-2" style={{ opacity: 0 }}>
            <div className="px-5 pt-5 pb-3 st2-1">
              <div className="text-[15px] font-medium text-gray-900 tracking-tight leading-snug">KI-Analyse</div>
              <div className="text-[10px] text-gray-400 font-medium mt-1.5">Abzüge werden automatisch erkannt</div>
            </div>
            <div className="flex-grow flex flex-col items-center justify-center px-5 pb-14">
              {/* Avenzo logo as AI indicator */}
              <div className="relative w-16 h-16 flex items-center justify-center mb-7 st2-1">
                <div className="w-14 h-14 bg-gray-900 rounded-2xl flex items-center justify-center shadow-med">
                  <img src="/avenzo_icon.svg" className="w-7 h-7 object-contain" style={{ filter: "brightness(0) invert(1)" }} alt="" />
                </div>
                <div className="absolute inset-0 rounded-2xl border border-gray-900/10 animate-ping" style={{ animationDuration: "2s" }} />
              </div>
              {/* Findings — staggered */}
              <div className="w-full space-y-2">
                <div className="bg-white rounded-2xl border border-gray-100 p-3.5 flex items-center gap-3 shadow-soft st2-2">
                  <div className="w-6 h-6 rounded-full bg-[var(--color-accent)] flex items-center justify-center shrink-0">
                    <svg className="w-3 h-3 text-[var(--color-accent-text)]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="3"><path strokeLinecap="round" strokeLinejoin="round" d="M5 13l4 4L19 7" /></svg>
                  </div>
                  <div className="flex-grow min-w-0">
                    <div className="text-[10px] font-semibold text-gray-900">Einkommen verifiziert</div>
                    <div className="text-[8px] text-gray-400 font-medium mt-0.5">CHF 85'400 Bruttolohn</div>
                  </div>
                </div>
                <div className="bg-white rounded-2xl border border-gray-100 p-3.5 flex items-center gap-3 shadow-soft st2-3">
                  <div className="w-6 h-6 rounded-full bg-[var(--color-accent)] flex items-center justify-center shrink-0">
                    <svg className="w-3 h-3 text-[var(--color-accent-text)]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="3"><path strokeLinecap="round" strokeLinejoin="round" d="M5 13l4 4L19 7" /></svg>
                  </div>
                  <div className="flex-grow min-w-0">
                    <div className="text-[10px] font-semibold text-gray-900">3 Abzüge gefunden</div>
                    <div className="text-[8px] text-gray-400 font-medium mt-0.5">Pendler · Homeoffice · 3a</div>
                  </div>
                </div>
                <div className="bg-white rounded-2xl border border-gray-100 p-3.5 flex items-center gap-3 st2-4">
                  <div className="w-6 h-6 rounded-full bg-gray-100 flex items-center justify-center shrink-0">
                    <div className="w-3 h-3 rounded-full border-[1.5px] border-[var(--color-accent-dark)] border-t-transparent anim-spin-slow" />
                  </div>
                  <div className="flex-grow min-w-0">
                    <div className="text-[10px] font-semibold text-gray-900">Optimierung berechnen</div>
                    <div className="w-full h-[2px] bg-gray-100 rounded-full mt-1.5 overflow-hidden">
                      <div className="h-full bg-[var(--color-accent)] rounded-full st2-bar" />
                    </div>
                  </div>
                </div>
              </div>
        ...
        <div className="flex-grow flex flex-col relative overflow-hidden bg-surface-subtle">
          ...
          <div className="absolute inset-0 flex flex-col px-5 pt-4 pb-14 anim-2screen-1">
            ...
            <div className="bg-white rounded-2xl border border-gray-100 p-4 mb-4 s1-stagger-2">
              ...
              <div>
                <div className="flex justify-between items-baseline mb-1.5">
                  <span className="text-[9px] font-medium text-app-insurance">Mit Avenzo</span>
                  <span className="text-[11px] font-bold text-gray-900">CHF 3'840</span>
                </div>
                <div className="w-full h-[6px] bg-gray-100 rounded-full overflow-hidden">
                  <div className="h-full bg-app-insurance rounded-full anim-bar-avenzo" />
                </div>
              </div>
          ...
          <div className="absolute inset-0 flex flex-col px-5 pt-4 pb-14 anim-2screen-2" style={{ opacity: 0 }}>
            ...
            <div className="flex gap-4 mb-4 s2-stagger-2">
              <div>
                <div className="text-[8px] font-medium text-app-insurance uppercase tracking-wider mb-0.5">Avenzo</div>
              ...
              <svg className="w-full h-full" viewBox="0 0 220 110" preserveAspectRatio="none">
                <defs>
                  <linearGradient id="avzFill2" x1="0" y1="0" x2="0" y2="1">
                    <stop offset="0%" stopColor="var(--color-app-insurance)" stopOpacity="0.08" />
                    <stop offset="100%" stopColor="var(--color-app-insurance)" stopOpacity="0" />
                  </linearGradient>
                </defs>
                {/* Subtle grid */}
                ...
                {/* Avenzo — draws in */}
                <path d="M0 95 Q55 85,110 55 T220 12" fill="none" stroke="var(--color-app-insurance)" strokeWidth="2.5" className="anim-draw-line" />
                {/* End dot — appears after line draws */}
                <circle cx="220" cy="12" r="3.5" fill="var(--color-app-insurance)" className="anim-chart-dot" />
                {/* Time labels */}
            ...
            <div className="flex items-center justify-center gap-5 mb-3 s2-stagger-3">
              <div className="flex items-center gap-1.5">
                <div className="w-3 h-[2px] rounded-full bg-app-insurance" />
            ...
            <div className="bg-app-insurance/[0.06] rounded-xl px-4 py-3 text-center s2-stagger-4">
              <div className="text-[10px] font-bold text-app-insurance">+CHF 182'000</div>
      ...
      <div className="flex flex-grow overflow-hidden">
        ...
        <div className="hidden md:flex w-[200px] border-r border-gray-100 p-4 flex-col bg-surface-subtle shrink-0">
          ...
          <div className="flex items-center gap-2 mb-6">
            <img src="/avenzo_icon.svg" className="h-4 w-auto object-contain" style={{ filter: "brightness(0)" }} alt="" />
            <span className="text-[10px] font-bold tracking-[0.08em] text-gray-900">avenzo</span>
          </div>
